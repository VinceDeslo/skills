...
| [refresh-personal](skills/refresh-personal/SKILL.md) | Fast-forward the default branch of every repository under `~/repos/personal`, discovering them with worktrunk |
| [refresh-work](skills/refresh-work/SKILL.md) | Fast-forward the default branch of every repository under `~/repos/work`, discovering them with worktrunk |
