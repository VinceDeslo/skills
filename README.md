...
| [pr-assignments](skills/pr-assignments/SKILL.md) | Crawl every open GitHub PR awaiting your review, summarize each in a line with its comment conversation, CI state, and review status, and rank them by review-SLA expiry into a self-contained HTML report |
