...
| [design-doc](skills/design-doc/SKILL.md) | Write a design doc for a software idea and publish it into the Obsidian vault at `~/repos/personal/brain`, filed under the source repository's path |
